...
// with a generic type variable. This odd-looking definition says that a
// ProgramScope<T> is a *non-empty* array of LocalScope<T> values: it's always
// guaranteed to have an element at index 0.
